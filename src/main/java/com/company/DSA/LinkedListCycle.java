 ...
 *   2. Floyd's tortoise and hare (slow 1, fast 2) gives O(1) space.
 *   3. If two runners on a closed loop, the faster one MUST lap the slower one.
 * ============================================================ */
 ...
 *
 *  Why fast.next != null check:
 *    fast.next.next would NPE if fast.next is null.
 *
 *  Termination:
